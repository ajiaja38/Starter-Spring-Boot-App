...
public class JwtUtils {
  ...
  public String generatedAccessToken(AppUser appUser) {
    return this.generateToken(appUser, getAlgorithm(), this.jwtExpiration);
  }

  public String generatedRefreshToken(AppUser appUser) {
    return this.generateToken(appUser, getAlgorithmRefreshToken(), this.jwtExpirationRefresh);
  }
  ...
  public Map<String, String> getUserInfoByToken(String token) {
    try {
      DecodedJWT decodedJWT = this.decodedJWT(getAlgorithm(), token);
